...
export async function collectSensorByHashInputs(config: WorkspaceConfiguration, context: ExtensionContext) {
    ...
    const steps: Step[] = [
        ...
        },
        {
            ...
            step: 6,
            totalSteps: 7,
            activeItemPropertyName: 'sensorHash',
            inputPrompt: 'Please enter the sensor hash'
        }
    ];

    const state = {} as Partial<SensorByHashState>;
    ...
    // store data
    return state as SensorByHashState;
}
