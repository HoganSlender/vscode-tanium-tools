...
interface ServerServerConnectConfigurationState {
...
export async function collectServerServerConnectConfigurationInputs(config: WorkspaceConfiguration, context: ExtensionContext) {
    ...
    const state = {} as Partial<ServerServerConnectConfigurationState>;
    await collectInputs('Compare Tanium Server Endpoint Configurations to Tanium Server Connect Configurations', state, steps);
    ...
    // store data
    return state as ServerServerConnectConfigurationState;
}
