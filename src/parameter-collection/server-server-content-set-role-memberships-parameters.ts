...
interface ServerServerContentSetRoleMembershipState {
...
export async function collectServerServerContentSetRoleMembershipInputs(config: WorkspaceConfiguration, context: ExtensionContext) {
    ...
    const state = {} as Partial<ServerServerContentSetRoleMembershipState>;
    await collectInputs('Compare Tanium Server Content Set Role Memberships to Tanium Server Content Set Role Memberships', state, steps);
    ...
    // store data
    return state as ServerServerContentSetRoleMembershipState;
}
