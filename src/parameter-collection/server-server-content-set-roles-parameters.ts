...
interface ServerServerContentSetRoleState {
...
export async function collectServerServerContentSetRoleInputs(config: WorkspaceConfiguration, context: ExtensionContext) {
    ...
    // store data
    return state as ServerServerContentSetRoleState;
}
