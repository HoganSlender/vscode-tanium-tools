...
interface ServerServerContentSetUserGroupRoleMembershipState {
...
export async function collectServerServerContentSetUserGroupRoleMembershipInputs(config: WorkspaceConfiguration, context: ExtensionContext) {
    ...
    // store data
    return state as ServerServerContentSetUserGroupRoleMembershipState;
}
