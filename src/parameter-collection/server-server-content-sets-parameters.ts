...
interface ServerServerContentSetState {
...
export async function collectServerServerContentSetInputs(config: WorkspaceConfiguration, context: ExtensionContext) {
    ...
    // store data
    return state as ServerServerContentSetState;
}
