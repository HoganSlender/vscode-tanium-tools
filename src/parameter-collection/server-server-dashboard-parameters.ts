...
interface ServerServerDashboardState {
...
export async function collectServerServerDashboardInputs(config: WorkspaceConfiguration, context: ExtensionContext) {
    ...
    // store data
    return state as ServerServerDashboardState;
}
