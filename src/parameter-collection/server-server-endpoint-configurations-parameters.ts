...
interface ServerServerEndpointConfigurationState {
...
export async function collectServerServerEnpdointConfiguratinInputs(config: WorkspaceConfiguration, context: ExtensionContext) {
    ...
    const state = {} as Partial<ServerServerEndpointConfigurationState>;
    await collectInputs('Compare Tanium Server Endpoint Configurations to Tanium Server Endpoint Configurations', state, steps);
    ...
    // store data
    return state as ServerServerEndpointConfigurationState;
}
