...
interface ServerServerModifiedSensorState {
...
export async function collectServerServerModifiedSensorInputs(config: WorkspaceConfiguration, context: ExtensionContext) {
    ...
    const state = {} as Partial<ServerServerModifiedSensorState>;
    ...
    // store data
    return state as ServerServerModifiedSensorState;
}
