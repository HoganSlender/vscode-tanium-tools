...
interface ServerServerPackageState {
...
export async function collectServerServerPackageInputs(config: WorkspaceConfiguration, context: ExtensionContext) {
    ...
    const state = {} as Partial<ServerServerPackageState>;
    ...
    // store data
    return state as ServerServerPackageState;
}
