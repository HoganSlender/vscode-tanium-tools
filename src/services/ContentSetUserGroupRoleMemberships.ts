...
export function activate(context: vscode.ExtensionContext) {
    commands.register(context, {
        'hoganslendertanium.analyzeContentSetUserGroupRoleMemberships': (diffItems: DiffItemData) => {
...
export class ContentSetUserGroupRoleMemberships extends DiffBase {
    static async analyzeContentSetUserGroupRoleMemberships(diffItems: DiffItemData, context: vscode.ExtensionContext) {
    ...
    static async transferContentSetUserGroupRoleMembership(
        ...
        const p = new Promise<void>(async (resolve, reject) => {
            ...
            try {
                ...
                const data = await RestClient.post(`https://${destFqdn.fqdn}/api/v2/content_set_user_group_role_memberships`, {
                    headers: {
                        session: session,
                    },
                    json: newObject,
