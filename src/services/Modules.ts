...
export function activate(context: vscode.ExtensionContext) {
    commands.register(context, {
        'hoganslendertanium.analyzeModules': (label, diffItems) => {
            Modules.analyzeModules(label, diffItems, context);
        },
    });
}

export class Modules extends DiffBase {
    static async analyzeModules(label: string, diffItems: DiffItemData, context: vscode.ExtensionContext) {
